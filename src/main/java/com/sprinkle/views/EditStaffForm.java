 ...
 * @author User
 */
public class EditStaffForm extends javax.swing.JDialog {
...
private AdminController adminController = new AdminController();
     ...
     */
    public EditStaffForm(java.awt.Frame parent, boolean modal, AdminModel admin) {
        super(parent, modal);
        this.admin = admin;
        initCustomForm();
    }
    ...
    public static void main(String args[]) {
        ...
        public void run() {
           ...
           AdminModel dummyAdmin = new AdminModel(
            ...
            EditStaffForm dialog = new EditStaffForm(new javax.swing.JFrame(), true, dummyAdmin);
