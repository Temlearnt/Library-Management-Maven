 ...
 * @author User
 */
public class AddAdminForm extends javax.swing.JDialog {
private AdminController adminController = new AdminController();

    /**
     * Creates new form AddAdminForm
     */
    public AddAdminForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initCustomForm();
    }
        ...
        btnSave.addActionListener(e -> {
           try {
            ...
            AdminModel admin = new AdminModel(
                ...
                email,
                phone,
                "admin" // default role (boleh diabaikan karena SQL sudah hardcode)
            );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddAdminForm dialog = new AddAdminForm(new javax.swing.JFrame(), true);
